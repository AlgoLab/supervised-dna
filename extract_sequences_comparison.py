...
FOLDER_FASTA = Path(f"data-outer-comparison/{SPECIE}") # here will be saved the selected sequences by clade
...
undersample = pd.read_csv("nextclade-comparison/outer_clades.csv").to_dict("records")
